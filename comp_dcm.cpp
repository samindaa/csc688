...
void CompDCMUpdate(tCompDCM *psDCM)
{
  ...
  VectorScale(psDCM->ppfDCM[0], psDCM->ppfDCM[0],
      0.5 * (3.0 - VectorDotProduct(psDCM->ppfDCM[0], psDCM->ppfDCM[0])));
  VectorScale(psDCM->ppfDCM[2], psDCM->ppfDCM[2],
      0.5 * (3.0 - VectorDotProduct(psDCM->ppfDCM[2], psDCM->ppfDCM[2])));
  ...
  // NaN) values.
  //
  bNAN = (isnan(psDCM->ppfDCM[0][0]) || isnan(psDCM->ppfDCM[0][1]) || isnan(psDCM->ppfDCM[0][2])
      || isnan(psDCM->ppfDCM[1][0]) || isnan(psDCM->ppfDCM[1][1]) || isnan(psDCM->ppfDCM[1][2])
      || isnan(psDCM->ppfDCM[2][0]) || isnan(psDCM->ppfDCM[2][1]) || isnan(psDCM->ppfDCM[2][2]));
...
void CompDCMComputeQuaternion(tCompDCM *psDCM, float pfQuaternion[4])
{
  ...
  if ((fQs > fQx) && (fQs > fQy) && (fQs > fQz))
  {
    ...
    //
    pfQuaternion[0] = fQs;
    pfQuaternion[1] = ((psDCM->ppfDCM[2][1] - psDCM->ppfDCM[1][2]) / (4 * fQs));
    pfQuaternion[2] = ((psDCM->ppfDCM[0][2] - psDCM->ppfDCM[2][0]) / (4 * fQs));
    pfQuaternion[3] = ((psDCM->ppfDCM[1][0] - psDCM->ppfDCM[0][1]) / (4 * fQs));
  }
  ...
  else if ((fQx > fQy) && (fQx > fQz))
  {
    ...
    //
    pfQuaternion[0] = ((psDCM->ppfDCM[2][1] - psDCM->ppfDCM[1][2]) / (4 * fQx));
    pfQuaternion[1] = fQx;
    pfQuaternion[2] = ((psDCM->ppfDCM[1][0] + psDCM->ppfDCM[0][1]) / (4 * fQx));
    pfQuaternion[3] = ((psDCM->ppfDCM[0][2] + psDCM->ppfDCM[2][0]) / (4 * fQx));
  }
  ...
  else if (fQy > fQz)
  {
    ...
    //
    pfQuaternion[0] = ((psDCM->ppfDCM[0][2] - psDCM->ppfDCM[2][0]) / (4 * fQy));
    pfQuaternion[1] = ((psDCM->ppfDCM[1][0] + psDCM->ppfDCM[0][1]) / (4 * fQy));
    pfQuaternion[2] = fQy;
    pfQuaternion[3] = ((psDCM->ppfDCM[2][1] + psDCM->ppfDCM[1][2]) / (4 * fQy));
  }
  ...
  else
  {
    ...
    //
    pfQuaternion[0] = ((psDCM->ppfDCM[1][0] - psDCM->ppfDCM[0][1]) / (4 * fQz));
    pfQuaternion[1] = ((psDCM->ppfDCM[0][2] + psDCM->ppfDCM[2][0]) / (4 * fQz));
