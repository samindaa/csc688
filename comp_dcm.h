...
//
//*****************************************************************************
extern void CompDCMInit(tCompDCM *psDCM, float fDeltaT, float fScaleA, float fScaleG,
    float fScaleM);
extern void CompDCMAccelUpdate(tCompDCM *psDCM, float fAccelX, float fAccelY, float fAccelZ);
extern void CompDCMGyroUpdate(tCompDCM *psDCM, float fGyroX, float fGyroY, float fGyroZ);
extern void CompDCMMagnetoUpdate(tCompDCM *psDCM, float fMagnetoX, float fMagnetoY,
    float fMagnetoZ);
...
extern void CompDCMComputeEulers(tCompDCM *psDCM, float *pfRoll, float *pfPitch, float *pfYaw);
...
extern void VectorCrossProduct(float pfVectorOut[3], float pfVectorIn1[3], float pfVectorIn2[3]);
extern void VectorScale(float pfVectorOut[3], float pfVectorIn[3], float fScale);
extern void VectorAdd(float pfVectorOut[3], float pfVectorIn1[3], float pfVectorIn2[3]);
